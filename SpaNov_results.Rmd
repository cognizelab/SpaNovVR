...
# Write .csv file
write.csv(x = temp_data, file = "other_stuff/source_data_files/Fig_1d_1.csv", 
          quote = FALSE, row.names = FALSE)

# Prepare data for 3D plot for the average time between visits to each sector
## Remove NA values & remove wrong column
temp_data <- na.omit(sector_average)
temp_data <- temp_data[,-2]

# Write .csv file
write.csv(x = temp_data, file = "other_stuff/source_data_files/Fig_1d_2.csv", 
          quote = FALSE, row.names = FALSE)
...
# Create data 2 save
data2save      <- total_path_lengths
data2save$ppid <- NULL

# Write .csv file
write.csv(x = data2save, file = "other_stuff/source_data_files/Fig_1c_1_path-lengths.csv", 
          quote = FALSE, row.names = FALSE)
...
# Create data to save
data2save <- data.frame(duration = event_df$duration)

# Write .csv file
write.csv(x = data2save, file = "other_stuff/source_data_files/Fig_1c_2_event-duration.csv", 
          quote = FALSE, row.names = FALSE)
...
# Write .csv file
write.csv(x = sector_rayleigh, file = "other_stuff/source_data_files/Fig_1c_3_rayleigh.csv", 
          quote = FALSE, row.names = FALSE)
...
data2save      <- locomotion_per
data2save$ppid <- NULL

# Write .csv
write.csv(x = data2save, file = "other_stuff/source_data_files/Fig_1c_4_locomotion.csv", 
          quote = FALSE, row.names = FALSE)
...
# Write .csv file for source data
write.csv(x = pred1_df, file = "other_stuff/source_data_files/Fig_1d_3_run1.csv", 
          quote = FALSE, row.names = FALSE)
write.csv(x = pred2_df, file = "other_stuff/source_data_files/Fig_1d_4_run2.csv", 
          quote = FALSE, row.names = FALSE)
...
# Create data to save
data2save     <- HC_data_plotting
data2save$max <- NULL

# Write .csv file for source data
write.csv(x = HC_data_plotting, file = "other_stuff/source_data_files/Fig_2c_1_scatter.csv", 
          quote = FALSE, row.names = FALSE)
...
# Write ,csv file
write.csv(x = individual_slope_df, file = "other_stuff/source_data_files/Fig_2c_2_boxplot.csv", 
          quote = FALSE, row.names = FALSE)
...
# Create data to save
data2save <- ddply(pred_means_subject_draws, c("subject"), summarise, 
                   lb = quantile(-draw, prob = 0.025),
                   median = median(-draw),
                   ub = quantile(-draw, prob = 0.975))
data2save$subject <- NULL

# Write for source data
write.csv(x = data2save, file = "other_stuff/source_data_files/Fig_4c.csv", 
          quote = FALSE, row.names = FALSE)
...
# Manually calculating density so we can share aggregate data because 50,000
# samples is too much
density_calc   <- density(mae_response_draws$draw , bw = "nrd0")
manual_density <- data.frame(x = density_calc$x, y = density_calc$y, 
                             scaled = density_calc$y / max(density_calc$y))

# Write for source data
write.csv(x = manual_density, file = "other_stuff/source_data_files/Fig_4b.csv", 
          quote = FALSE, row.names = FALSE)
...
### Figure S1 | Spatial learning during encoding
...
# Manually calculating density so we can share aggregate data because 50,000
# samples is too much
density_calc   <- density(mae1_navTime_respone_draws$draw , bw = "nrd0")
manual_density <- data.frame(x = density_calc$x, y = density_calc$y, 
                             scaled = density_calc$y / max(density_calc$y))

# Write for source data
write.csv(x = manual_density, file = "other_stuff/source_data_files/Fig_S01a.csv", 
          quote = FALSE, row.names = FALSE)
...
# Write for source data
write.csv(x = pred_line_subject_navTime1, file = "other_stuff/source_data_files/Fig_S01b.csv", 
          quote = FALSE, row.names = FALSE)
...
### Figure S2 | Differences in locomotion in novel versus familiar parts of the environment
```{r locomotion}
...
# Create data write
data2save1        <- reshape2::dcast(ev_info_agg, subj ~ level, value.var = c("mean_per_tra_arc"))
data2save1$subj   <- NULL
names(data2save1) <- paste0("translation_",names(data2save1))
data2save2        <- reshape2::dcast(ev_info_agg, subj ~ level, value.var = c("mean_per_rot_arc"))
data2save2$subj   <- NULL
names(data2save2) <- paste0("rotation_",names(data2save2))
data2save3        <- reshape2::dcast(ev_info_agg, subj ~ level, value.var = c("mean_per_sta_arc"))
data2save3$subj   <- NULL
names(data2save3) <- paste0("stationary_",names(data2save3))
data2save         <- cbind(data2save1, data2save2, data2save3)

# Write for source data
write.csv(x = data2save, file = "other_stuff/source_data_files/Fig_S02.csv", 
          quote = FALSE, row.names = FALSE)
...
### Figure S3 | Distribution of high spatial novelty events across areal partitions of the environment
...
# Create data to save
data2save <- data.frame(pos_x = event_info_df_lvl1$pos_x,
                        pos_z = event_info_df_lvl1$pos_z)

# Write for source data
write.csv(x = data2save, file = "other_stuff/source_data_files/Fig_S03.csv", 
          quote = FALSE, row.names = FALSE)
...
### Figure S4 | Influence of centrality on spatial novelty effects.
...
# Combine plots
ggsave(p, filename = paste0(figurePath, "Fig_S04_control_for_centrality.png"), 
       dpi = dpi, width = 180, height = 57, units = "mm")
```

### Figure S5 | Association between individual differences in preference for the centre and spatial novelty effects
...
# Create data to save
data2save      <- avg_centrality
data2save$ppid <- NULL
data2save$subject <- NULL
names(data2save)[1] <- "centrality_score"

# Write for source data
write.csv(x = data2save, file = "other_stuff/source_data_files/Fig_S05.csv", 
          quote = FALSE, row.names = FALSE)
...
### Figure S6 | Hippocampal gradient based on maximum z-statistic
```{r HC_grad_max}
...
# Write for source data
write.csv(x = HC_supp_fig_data, file = "other_stuff/source_data_files/Fig_S06.csv", 
          quote = FALSE, row.names = FALSE)
...
### Figure S7 | Hippocampal gradient without the assumption of medial to lateral homogeneity
...
# Write for source data
write.csv(x = data2save, file = "other_stuff/source_data_files/Fig_S07.csv", 
          quote = FALSE, row.names = FALSE)
...
### Figure S8 | Association of spatial novelty and memory
...
# Write for source data
write.csv(x = obj_avg, file = "other_stuff/source_data_files/Fig_S08a-c.csv", 
          quote = FALSE, row.names = FALSE)
...
# Write for source data
write.csv(x = encoding_WB_df, file = "other_stuff/source_data_files/Fig_S08e.csv", 
          quote = FALSE, row.names = FALSE)
...
### Figure S9 | Distribution of principal functional connectivity gradient scores across spatial novelty preference levels in the posterior medial cortex
```{r PMC_Margulies}
...
# Write for source data
write.csv(x = Margulies_grad_PMC, file = "other_stuff/source_data_files/Fig_S09.csv", 
          quote = FALSE, row.names = FALSE)
...
Margulies_novelty <- ggplot(Margulies_grad_PMC, aes(x = PMC_gradient, y = Grad_1, fill = PMC_gradient)) +
  ...
  theme_journal() + 
  theme(legend.position = "none") +
  labs(x = "Spatial novelty-familarity gradient (PMC)", y = TeX(r"( $Margulies'\ et\ al^{2}\ 1^{st}\ gradient$ )"))
...
### Figure S10 | Cortico-hippocampal connectivity patterns and principal functional connectivity gradients
...
data2save      <- reshape2::dcast(HC_2_Margulies_agg2, Rnum ~ Gradient, value.var = c("diff"))
data2save$Rnum <- NULL

# Write for source data
write.csv(x = data2save, file = "other_stuff/source_data_files/Fig_S10.csv", 
          quote = FALSE, row.names = FALSE)
...
### Figure S11 | Posterior predictive checks for hierarchical models
...
### Figure S12 | Distribution of starting locations relative to object locations
...
# Create data frame to save
data2save <- data.frame(start_x = start_vis_data$start_x,
                        start_z = start_vis_data$start_z,
                        object_x = start_vis_data$object_x,
                        object_z = start_vis_data$object_z,
                        targetNames = start_vis_data$targetNames)

# Write for source data
write.csv(x = data2save, file = "other_stuff/source_data_files/Fig_S12.csv", 
          quote = FALSE, row.names = FALSE)
...
### Figure S13 | Relationship between the number of visits and the time elapsed since last visit to a given sector
...
# Write for source data
write.csv(x = pred1_df, file = "other_stuff/source_data_files/Fig_S13b_1_run1.csv", 
          quote = FALSE, row.names = FALSE)
write.csv(x = pred2_df, file = "other_stuff/source_data_files/Fig_S13b_2_run2.csv", 
          quote = FALSE, row.names = FALSE)
...
# Write for source data
write.csv(x = pred1_df, file = "other_stuff/source_data_files/Fig_S13c_1_run1.csv", 
          quote = FALSE, row.names = FALSE)
write.csv(x = pred2_df, file = "other_stuff/source_data_files/Fig_S13c_2_run2.csv", 
          quote = FALSE, row.names = FALSE)
...
# Create data to save
data2save <- data.frame(number_of_visits = event_info_df_encoding$visits,
                        time_elapsed = event_info_df_encoding$lastVisit)

# Write for source data
write.csv(x = data2save, file = "other_stuff/source_data_files/Fig_S13a.csv", 
          quote = FALSE, row.names = FALSE)
